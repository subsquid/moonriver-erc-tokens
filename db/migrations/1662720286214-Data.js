module.exports = class Data1662720286214 {
  name = 'Data1662720286214'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "ft_transfer" ("id" character varying NOT NULL, "block_number" numeric NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "event_index" integer NOT NULL, "txn_hash" text NOT NULL, "amount" numeric, "transfer_type" character varying(8), "from_id" character varying, "to_id" character varying, "token_id" character varying, CONSTRAINT "PK_9197e98e6e5fc3ead382a4b80a3" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "account_f_token_balance" ("id" character varying NOT NULL, "amount" numeric NOT NULL, "updated_at_block" numeric NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "account_id" character varying, "token_id" character varying, CONSTRAINT "PK_c5ff211ac7ea9f25010a8ceab68" PRIMARY KEY ("id"))`)
