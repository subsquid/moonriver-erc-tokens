module.exports = class Data1658932917620 {
  name = 'Data1658932917620'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "collection" ("id" character varying NOT NULL, "collection_type" character varying(7) NOT NULL, "created_at_block" numeric NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "current_owner_id" character varying NOT NULL, CONSTRAINT "PK_ad3f485bbc99d875491f44d7c85" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_3fecce93788f86b3c2d76f5bb2" ON "collection" ("collection_type") `)
    await db.query(`CREATE INDEX "IDX_7731cb046dfb5832762ef4e0bb" ON "collection" ("current_owner_id") `)
    ...
    await db.query(`CREATE TABLE "nft_transfer" ("id" character varying NOT NULL, "block_number" numeric NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "event_index" integer NOT NULL, "txn_hash" text NOT NULL, "amount" numeric, "transfer_type" character varying(8), "is_batch" boolean NOT NULL, "from_id" character varying NOT NULL, "to_id" character varying NOT NULL, "token_id" character varying NOT NULL, CONSTRAINT "PK_2d9d4b37560ecbcae8bd13026ab" PRIMARY KEY ("id"))`)
    ...
    await db.query(`ALTER TABLE "collection" ADD CONSTRAINT "FK_7731cb046dfb5832762ef4e0bb2" FOREIGN KEY ("current_owner_id") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_7731cb046dfb5832762ef4e0bb"`)
    ...
    await db.query(`ALTER TABLE "collection" DROP CONSTRAINT "FK_7731cb046dfb5832762ef4e0bb2"`)
