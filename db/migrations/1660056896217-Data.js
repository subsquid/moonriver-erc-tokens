module.exports = class Data1660056896217 {
  name = 'Data1660056896217'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "uri_update_action" ("id" character varying NOT NULL, "new_value" text, "old_value" text, "block_number" numeric NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "token_id" character varying NOT NULL, CONSTRAINT "PK_0de40fe0fe070f895e84d31ecd0" PRIMARY KEY ("id"))`)
